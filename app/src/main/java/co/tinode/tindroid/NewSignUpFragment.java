...
public class NewSignUpFragment extends Fragment
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View fragment = inflater.inflate(R.layout.fragment_new_signup, container, false);
        fragment.findViewById(R.id.login).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        tinode.connect(hostName, tls, false)
                ...
                .thenCatch(new PromisedReply.FailureListener<ServerMessage>() {
                    ...
                    public PromisedReply<ServerMessage> onFailure(Exception err) {
                        if (!NewSignUpFragment.this.isVisible()) {
                            return null;
                        }
