...
public class NewLoginFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View fragment = inflater.inflate(R.layout.fragment_new_login, container, false);
...
//        }
//
        fragment.findViewById(R.id.signUp).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final NewLoginActivity parent = (NewLoginActivity) getActivity();
                if (parent == null) {
                    return;
                }

                parent.showFragment(NewLoginActivity.FRAGMENT_SIGNUP, null, true);
            }
        });
